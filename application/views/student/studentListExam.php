						...
						<div class="col-md-12 ">
								...
								<article data-page="<?php echo ($exam->id % 5)+1; ?>"  >
                                    ...
                                    <!--<span class="add-favorite">
										...
										<span>
                                        <a target="_blank" href="<?php echo base_url(); ?>index.php/student/notes/exam/<?php echo $exam->id ; ?>/<?php echo $idStudent ; ?>" class="" data-title="See results"><i class="fa fa fa-envelope-open-o" aria-hidden="true"></i></a>
                                    </span>
										...
										<span>
                                        <a target="_blank" href="<?php echo base_url(); ?>index.php/student/correction/exam/<?php echo $exam->id ; ?>/<?php echo $idStudent ; ?>" class="" data-title="See correction"><i class="fa fa-address-card" aria-hidden="true"></i></a>
                                    </span>
										<?php } ?>
									</div>
									<div class="figure-list">
										<div class="image">
											...
											if($exam->no_remake_exam==false) {
												?> href="<?php echo base_url(); ?>index.php/student/pass/exam/<?php echo $exam->id ; ?>"
											...
											if($booleanNeverTaken==false){ ?>href="<?php echo base_url(); ?>index.php/student/pass/exam/<?php echo $exam->id ; ?>" <?php }} ?> class="mfp-open">
												<img src="<?php echo base_url(); ?>assets/images/avatars/exam.png" alt="" width="300" style="width: 70% !important;margin-left: 10%;" />
											</a>

										</div>
										<div class="text">
											<h2 class="title h4"><a target="_blank" <?php if($exam->no_remake_exam==false) { ?>  href="<?php echo base_url(); ?>index.php/student/pass/exam/<?php echo $exam->id ; ?>" <?php
											}else{
												$booleanNeverTaken=false;
												if(!empty($arrayneverTakenExam)) {
													foreach ($arrayneverTakenExam as $key => $nevrTakenExam) {
												...
												if($booleanNeverTaken==false){?>href="<?php echo base_url(); ?>index.php/student/pass/exam/<?php echo $exam->id ; ?>"  <?php }} ?>>Exam <?php echo $exam->title_exam; ?></a></h2>
											<?php foreach($listreponsesExam as $response) { ?>
											<?php if($response->exam_id==$exam->exam_id){ ?>
												<?php if($response->show_notes==true){ ?>
											<sup>Note : <?php if($response->note_by_teacher>=10){ ?><a style="color:green;font-weight: bold;"> <?php echo $response->note_by_teacher ; ?> </a> <?php  }else{ ?> <a style="color:red;font-weight: bold;"> <?php echo $response->note_by_teacher ; ?> </a> <?php }?></sup><br>
												<?php } ?>
											<?php } ?>
											<?php } ?>
