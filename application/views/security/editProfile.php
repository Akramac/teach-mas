		...
		<div class="container card  " style="margin-left: 20%;margin-top:5%;">
			...
			<div class="login-block login-block-signup">
				...
				<div class="row">
					...
					<form method="post" action="<?php echo base_url(); ?>index.php/edit-profile-treatment" enctype="multipart/form-data">
						<input type="text" name="user_id" class="form-control" value="<?php echo $_SESSION['id']; ?>"  hidden/>

						<div class="form-group col-md-6 col-md-offset-3">
							<label>Change your email</label>
							<input type="text" name="user_email" class="form-control" value="<?php echo $_SESSION['user_email']; ?>" />
							<span class="text-danger" style="color:red;"><?php echo form_error('user_email'); ?></span>
						</div>
						<div class="form-group col-md-6 col-md-offset-3">
							<label>Change Name</label>
							<input type="text" name="user_name" class="form-control" value="<?php  echo $_SESSION['user_name'];; ?>" placeholder="Your name"  />
