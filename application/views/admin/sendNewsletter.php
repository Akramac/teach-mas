				...
				<div class="col-md-9 col-xs-12">
					...
					<div class="sort-bar clearfix">
						<div class="sort-options pull-right">
							<span class="hidden-xs">Send Newsletter</span>
							<!--Grid-list view-->
					...
					<div class="row row-clean pagination-container">
						...
						<!--product-item-->
							...
							<div class="col-md-12 ">
									...
									<form method="POST" action="<?php echo base_url(); ?>index.php/admin/send-mail" enctype='multipart/form-data'>
										<label for="news">News to be sent by email :</label>
										<textarea class="form-control" name="news" id="name" style="height: 120px;"></textarea>
										<input type="submit" class=" btn btn-main" value="Submit" id="submit-news">
