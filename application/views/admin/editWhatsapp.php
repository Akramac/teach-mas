			...
			<div class="row row-clean">
				...
				<div class="col-md-9 col-xs-12">
					...
					<div class="row row-clean pagination-container">
						...
						<form method="POST" action="<?php echo base_url(); ?>index.php/admin/edit-whatsapp" enctype='multipart/form-data'>



							<label for="category">Whatsapp Number</label>
							<input type="text" placeholder="Write your number"   value="<?php echo $whatsapp->number;?>" name="whatsapp_number" required>
