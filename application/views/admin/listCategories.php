				...
				<div class="col-md-9 col-xs-12">
					...
					<div class="sort-bar clearfix">
						<div class="sort-options pull-right">
							<span class="hidden-xs">List of Categories</span>
							<!--Grid-list view-->
					...
					<div class="row row-clean pagination-container">
						...
						<?php foreach($categories as $categorie) { ?>
							<div class="col-md-12 ">
								...
								<article data-page="<?php echo ($categorie->id % 5)+1; ?>"  >
									<div class="info">
										<span>
                                        <a target="_blank" href="<?php echo base_url(); ?>index.php/admin/edit-categories/<?php echo $categorie->id ; ?>" class="" data-title="edit category"><i class="icon icon-pencil"></i></a>
                                    </span>
									</div>
									<div class="figure-list">
										<div class="image">
											<a  target="_blank" href="" class="mfp-open">
												<img src="<?php echo base_url(); ?>assets/images/cat.jpg" alt="" width="300" style="width: 70% !important;margin-left: 10%;" />
											</a>
										</div>
										<div class="text">
											<h2 class="title h4"><a target="_blank" href="<?php echo base_url(); ?>index.php/admin/edit-categories/<?php echo $categorie->id ; ?>">Category : <?php echo $categorie->name; ?></a></h2>
											<sup>Date of creation : <?php echo $categorie->date_created ; ?></sup>
										</div>
									</div>
								</article>
