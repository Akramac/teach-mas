			...
			<div class="row row-clean">
				...
				<div class="col-md-9 col-xs-12">
					...
					<div class="row row-clean pagination-container">
						...
						<form method="POST" action="<?php echo base_url(); ?>index.php/admin/update-category" enctype='multipart/form-data'>



                                    <label for="category">Category name</label>
									<input type="text" placeholder="Write name of category"  id="category" value="<?php echo $category->name ;?>" name="category" required>
									<input type="text" placeholder="id"  id="id_category" value="<?php echo $category->id ;?>" name="category_id" required hidden>

									<label for="category">Category image</label>
									<img alt="no image" src="<?php echo base_url()?>assets/uploads/categories/<?php echo $category->image;?>" style="width:140px;"/>
									<div class = "file-field input-field">
										<div class = "btn">
											<span>Browse</span>
											<input name="file-image-category" type = "file" />
										</div>
