...
<div class="wrapper">
	...
	<section class="contact section-questions">
		...
		<div class="container">
			...
			<form id="msform-teacher" method="POST" action="<?php echo base_url(); ?>index.php/admin/edit-exam" enctype='multipart/form-data'>
				<div class="form-group">
					...
					<input type="text"  name="id_teacher" value="<?php echo $idTeacher; ?>" hidden>
				</div>
...
<a class="btn-floating btn-small waves-effect waves-light red remove-option-btn" > <i class="fa fa-minus"></i></a>
			...
			<div class="step-content">
				<div class="row">
					<div class="input-field col s12">
						...
						$(document).on('keydown', '.text-span', function() {
	...
	$(document).on('click', '.close-question', function() {
		...
		$.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>index.php/admin/delete-question",
			data: {
				'question_id':idQuest,
